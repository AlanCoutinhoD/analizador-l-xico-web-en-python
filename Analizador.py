...
class LexicalAnalyzerGUI(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.text_input = tk.Text(self, height=10, bg="#f0f0f0", fg="#333333", font=("Helvetica", 12))
        ...
        analyze_button = tk.Button(button_frame, text="Analizar", command=self.analyze_code, bg="#4CAF50", fg="white", font=("Helvetica", 12))
        analyze_button.pack(side=tk.LEFT, padx=10)

        clear_button = tk.Button(button_frame, text="Borrar Todo", command=self.clear_text, bg="#f44336", fg="white", font=("Helvetica", 12))
        clear_button.pack(side=tk.LEFT, padx=10)

        load_button = tk.Button(button_frame, text="Cargar Archivo", command=self.load_file, bg="#2196F3", fg="white", font=("Helvetica", 12))
...
if __name__ == "__main__":
    left_image_path = "gato1.png"
    
    
    if not os.path.exists(left_image_path) :
        print("Error, no existen imagenes")
    else:
        app = LexicalAnalyzerGUI()
        app.load_image_left("gato1.png")
